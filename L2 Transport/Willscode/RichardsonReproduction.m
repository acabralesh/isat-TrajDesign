%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Reproduce Richardson 1980 - Analytic
%    Construction of Periodic Orbits
%    About the Collinear Points Results
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
x = (a21*Ax^2 + a22*params.Az^2 - Ax*cos(tau1) + (a23*Ax^2 - a24*params.Az^2)*cos(2*tau1) + (a31*Ax^3-a32*Ax*params.Az^2)*cos(3*tau1))*rE;
y = (k*Ax*sin(tau1) + (b21*Ax^2-b22*params.Az^2)*sin(2*tau1) + (b31*Ax^3 - b32*Ax*params.Az^2)*sin(3*tau1))*rE;
z = (delta_n*params.Az*cos(tau1) + delta_n*d21*Ax*params.Az*(cos(2*tau1)-3)+delta_n*(d32*params.Az*Ax^2-d31*params.Az^3)*cos(3*tau1))*rE;
