function x0vec = halo_3bodyrot_richardson_init(mu, x_l, libind, Az, phi, n)
%HALO_3BODYROT_RICHARDSON_INIT(mu, x_l, libind, Az, phi, n) Richardson 3rd order
%initial solution for Halo orbit
%
% Purpose: Obtains an initial state solution for a halo orbit around
% specifiec libration point with desired altitude
%
% Inputs:
...
%
% Outputs: 
% x0vec     [6x1] initial state vector
%
% Co-dependencies
